...
void VSRam::traceInitThis__1(VSRam__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBus(c+65,"io_dout0", false,-1, 31,0);
        vcdp->declBit(c+49,"SRam clock", false,-1);
        vcdp->declBit(c+57,"SRam reset", false,-1);
        vcdp->declBus(c+65,"SRam io_dout0", false,-1, 31,0);
        vcdp->declBit(c+1,"SRam a_clk0", false,-1);
        vcdp->declBit(c+73,"SRam a_csb0", false,-1);
        vcdp->declBit(c+73,"SRam a_web0", false,-1);
        vcdp->declBus(c+81,"SRam a_addr0", false,-1, 6,0);
        vcdp->declBus(c+89,"SRam a_din0", false,-1, 31,0);
        vcdp->declBus(c+9,"SRam a_dout0", false,-1, 31,0);
        vcdp->declBus(c+97,"SRam a DATA_WIDTH", false,-1, 31,0);
        vcdp->declBus(c+105,"SRam a ADDR_WIDTH", false,-1, 31,0);
        vcdp->declBus(c+113,"SRam a RAM_DEPTH", false,-1, 31,0);
        vcdp->declBus(c+121,"SRam a DELAY", false,-1, 31,0);
        vcdp->declBit(c+1,"SRam a clk0", false,-1);
        vcdp->declBit(c+73,"SRam a csb0", false,-1);
        vcdp->declBit(c+73,"SRam a web0", false,-1);
        vcdp->declBus(c+81,"SRam a addr0", false,-1, 6,0);
        vcdp->declBus(c+89,"SRam a din0", false,-1, 31,0);
...
void VSRam::traceFullThis__1(VSRam__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+65,(vlTOPp->io_dout0),32);
        vcdp->fullBit(c+73,(0U));
        vcdp->fullBus(c+81,(0U),7);
        vcdp->fullBus(c+89,(0U),32);
        vcdp->fullBus(c+97,(0x20U),32);
        vcdp->fullBus(c+105,(7U),32);
        vcdp->fullBus(c+113,(0x80U),32);
        vcdp->fullBus(c+121,(3U),32);
    }
}

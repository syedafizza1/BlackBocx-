...
#endif
#include <iostream>
class Adder_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    Adder_api_t(VAdder* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["Adder.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/Adder_is_beautiful/Adder.vcd";
    ...
    Verilated::mkdir("test_run_dir/Adder_is_beautiful/logs");
    VerilatedCov::write("test_run_dir/Adder_is_beautiful/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}

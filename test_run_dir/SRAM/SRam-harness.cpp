...
#endif
#include <iostream>
class SRam_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    SRam_api_t(VSRam* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["SRam.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VSRam* top = new VSRam;
    std::string vcdfile = "test_run_dir/SRAM/SRam.vcd";
    ...
    Verilated::mkdir("test_run_dir/SRAM/logs");
    VerilatedCov::write("test_run_dir/SRAM/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}

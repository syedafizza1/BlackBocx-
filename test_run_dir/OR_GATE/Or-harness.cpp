...
#endif
#include <iostream>
class Or_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    Or_api_t(VOr* _dut) {
        dut = _dut;
        main_time = 0L;
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["Or.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VOr* top = new VOr;
    std::string vcdfile = "test_run_dir/OR_GATE/Or.vcd";

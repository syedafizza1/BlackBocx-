...
class Counter_api_t: public sim_api_t<VerilatorDataWrapper*> {
    ...
    void init_sim_data() {
        ...
        sim_data.outputs.push_back(new VerilatorCData(&(dut->io_output)));
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/COUNTER/Counter.vcd";
    ...
    Verilated::mkdir("test_run_dir/COUNTER/logs");
    VerilatedCov::write("test_run_dir/COUNTER/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}

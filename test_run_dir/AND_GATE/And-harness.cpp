...
#endif
#include <iostream>
class And_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    And_api_t(VAnd* _dut) {
        dut = _dut;
        main_time = 0L;
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["And.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VAnd* top = new VAnd;
    std::string vcdfile = "test_run_dir/AND_GATE/And.vcd";
    ...
    Verilated::mkdir("test_run_dir/AND_GATE/logs");
    VerilatedCov::write("test_run_dir/AND_GATE/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
